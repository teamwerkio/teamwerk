<?php
	...
	if(!isset($_SESSION['usr'])){
		...
		$ong_sql="SELECT * FROM users WHERE usrID='".$_SESSION['usr']."'";
		$ong_qry=mysqli_query($dbconnect, $ong_sql);
		$ong_res=mysqli_fetch_assoc($ong_qry);
...
<head>
	...
	<title>Ongoing Projects | Teamwerk</title>
				...
				<div class="right-header">					
					<nav class="main-menu">
						...
						<ul>
							...
							<li>
								<a href="#"><?php echo $ong_res['firstname']; ?><i class="fa fa-caret-down" aria-hidden="true"></i></a>
								<ul class="sub-menu">
					...
					<div class="row">
						<div class="col-lg-3">
							<nav class="account-bar">
								<ul>
									<li><a href="dashboard.php">Dashboard</a></li>
									<li><a href="profile.php">Profile</a></li>
									<li class="active"><a href="ongoing_projects.php">Ongoing Projects</a></li>
									<li><a href="past_projects.php">Past Projects</a></li>
						...
						<div class="col-lg-9">
							<div class="account-content my-campaigns account-table">
								<h3 class="account-title">Ongoing Projects</h3>
